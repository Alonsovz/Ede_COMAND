...
<div style=" font-family: Tahoma, Helvetica, Arial">
    ...
    <div style="margin-top: 20px; ">
        <b style="font-size: 10px;">Fecha: </b> <small style="font-size: 10px"><?php $fecha=date_create($hojaactivo->fechacreacion); echo date('d/m/Y'); ?></small>
    </div>
    ...
    <div style="margin-top: 5px">
        ...
        <b style="font-size: 10px; margin-top: 5px">Motivo de baja:</b>
        <table class="minimalistBlack" style="font-family: Tahoma, Helvetica, Arial; margin-top: 15px; margin-bottom: 20px">
            <thead>
            ...
            <tbody>
            <tr>
            <td>{{$insumo->motivobaja}}</td>
            <td>@if($insumo->motivobaja=='Arruinado')<b>Se entrego activo <input style="margin-top: 7px" type="checkbox" checked="checked"></b> @else <b>No se entrego activo</b>@endif</td>
            </tr>
            </tbody>
            <tfoot>
        ...
        <table class="minimalistBlack" style="font-family: Tahoma, Helvetica, Arial; margin-top: 15px; margin-bottom: 20px">
            ...
            @if($insumo->motivobaja=='Robo' || $insumo->motivobaja=='Extravio')
        ...
        <table class="minimalistBlack" style="font-family: Tahoma, Helvetica, Arial; margin-top: 15px; margin-bottom: 20px">
            ...
            <tr style="width: 400px; height: 20px;">
                <td style="width: 600px;height: 20px"><b style="font-size: 10px">{{$motivoba}}</b></td>
            </tr>
