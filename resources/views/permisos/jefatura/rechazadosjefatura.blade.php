                    ...
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            ...
                            <ul class="folder-list m-b-md" style="padding: 0">
                                <li><a href="permisosjefatura"> <i class="fa fa-inbox "></i>Solicitudes <span class="label label-warning pull-right">{{$conteopermisos}}</span> </a></li>
                                        ...
                                        <div class="ibox-content">
                                            ...
                                            <form id="form" action="#" class="wizard-big form-horizontal">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4" style="margin-left: 10px">
                                                            <div class="form-group" id="data_2">
                                                                <label>Desea aplicar goce de sueldo</label>
                                                                <select id="gocesueldo" name="gocesueldo" class="form-control">
                                                                    <option>...</option>
                                                ...
                                                <p style="margin-top: 40px">
                                                    <button type="button" id="btn_aprobarsolicitud" class="btn btn-success btn-sm">
                                                        Aprobar solicitud
                                                    </button> 
                                                    <button type="button" id="btn_denegarsolicitud" class="btn btn-danger btn-sm">
                                                        Denegar solicitud
                                                    </button>
                                                </p>
                                                <span class="label label-warning">Recuerde revisar su calendario laboral para evitar problemas con fechas de proyectos y tareas del empleado solicitante</span>
                                                </fieldset>
