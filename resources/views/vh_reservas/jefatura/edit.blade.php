                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                @foreach($reserva as $r)
                                    <div class="m-b-md">
                                        @if($r->estadoreserva=='Vehiculo autorizado')
                                        <button type="button" id="{{$r->id}}"  class="btn btn-success btn-xs pull-right btn_aprobarreserva" style="margin-left: 5px"><i class="fa fa-hand-o-up" ></i> Aprobar</button>
                                        <button type="button" id="btn_denegarreserva"  class="btn btn-danger btn-xs pull-right btn_denegarresolucion"><i class="fa fa-hand-o-down" ></i> Denegar</button>
                                        @endif

                                        <a href="reservasjefatura" class="btn btn-warning btn-xs pull-right" style="margin-right: 5px"><i class="fa fa-arrow-left"></i> Bandeja</a>

                                        <h2>Resolucion de Reserva</h2>
                                    </div>
                         ...
                         <h3>
                             <b>
                                 <label class="label label-warning"
                                        for="">Es importante conocer el motivo de la denegacion para la solicitud de reserva del empleado </label>
                             </b>
                         </h3>
                </div>
                <div class="ibox-content" style="background-color: lightgrey; padding-left: 50px">
                    ...
                    <form class="form-horizontal" id="formularioreserva">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <button type="button" class="btn btn-success btn_guardarresolucion" id="{{$r->id}}">Guardar resolucion</button>
                                    <a  href="reservasjefatura" class="btn btn-danger">Cancelar</a>
                                </div>
                            </div>
