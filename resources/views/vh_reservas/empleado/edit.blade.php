                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="m-b-md">
                                    ...
                                    <a id="btn_editarreserva"  class="btn btn-warning btn-xs pull-right"><i class="fa fa-edit"></i> Editar reserva</a>
                                    @elseif($r->estadoreserva=='Solicitud denegada')

                                        @endif
                                    <a href="misreservas" class="btn btn-danger btn-xs pull-right" style="margin-right: 5px"><i class="fa fa-arrow-left"></i> Mis reservas</a>

                                    <h2>Edicion de Reserva</h2>
                                </div>
            ...
            <div class="ibox" >
                ...
                <div class="ibox-content" style="background-color: lightgrey; padding-left: 50px">
                    <form class="form-horizontal" id="formularioreserva">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="idreserva" value="{{$r->id}}" readonly="readonly">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button style="margin-left: 15px" type="button" id="disponibilidad1" class="btn btn-xs btn-warning">Comprobar disponibilidad</button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <button onclick="reload()" class="pull-right btn btn-sm btn-danger" id="" style="margin-left: 5px"><i class="fa fa-times-circle"></i> Cancelar</button>
                            <button class="pull-right btn btn-sm btn-success btn_actualizarreserva hidden " type="button"  id="{{$r->id}}"> <i class="fa fa-save"></i> Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
